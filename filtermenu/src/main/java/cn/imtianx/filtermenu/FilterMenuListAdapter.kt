 ...
 */
class FilterMenuListAdapter(private val layoutId: Int = R.layout.item_menu_list, private val data: List<String>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        viewHolder.mtvName.text = data[position]
